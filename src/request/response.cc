...
namespace http
{
void http_get(struct Request r, DefaultSocket socketClient, int port)
{
...
void http_head(struct Request r, DefaultSocket socketClient, int port)
{
...
void http_post(struct Request r, DefaultSocket socketClient, int port)
{
